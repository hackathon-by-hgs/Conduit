...
export function TelemetryPageHeader(props: TelemetryPageHeaderProps) {
  ...
  return (
    <header data-route-card className="relative grid min-h-[152px] grid-cols-1 overflow-hidden rounded-[20px] bg-gradient-to-br from-[#080808]/98 via-[#0b0b0b]/96 to-black/98 sm:rounded-[24px] md:min-h-[162px] md:grid-cols-[minmax(0,1fr)_290px] lg:grid-cols-[minmax(0,1.35fr)_minmax(290px,0.58fr)]">
      <span className="absolute left-5 top-0 h-[3px] w-[92px] rounded-b-full bg-[#A01016] sm:left-8 sm:w-[108px]" aria-hidden="true" />
      <div className="flex min-w-0 flex-col justify-center px-4 py-6 sm:px-5 md:px-9 md:py-8">
      ...
      <div className="relative grid min-w-0 grid-cols-1 bg-white/[0.025] md:border-l md:border-white/[0.07] lg:grid-cols-2">
        <div className="flex min-w-0 flex-col justify-center px-4 pb-10 pt-5 sm:px-5 md:p-7 lg:border-r lg:border-white/[0.07]">
        ...
        <div className="absolute bottom-4 left-4 right-4 flex gap-[3px] sm:bottom-5 sm:left-6 sm:right-6" aria-hidden="true">
